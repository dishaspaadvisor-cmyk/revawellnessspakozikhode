...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Reva Wellness Spa is open every day from 10:00 AM to 10:00 PM, including weekends and holidays.",
  },
  {
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="space-y-5">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="overflow-hidden rounded-[24px] bg-[#E9FFE4] shadow-sm transition-all"
              style={{
